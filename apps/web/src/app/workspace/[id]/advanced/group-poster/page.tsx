  ...
  return (
    <div className="max-w-4xl space-y-6 pb-20">
      ...
      <form onSubmit={handlePostGroup} className="border border-border bg-card p-5 sm:p-6 rounded-xl space-y-6 shadow-xs">
        ...
        <div className="border border-blue-500/20 bg-blue-50/20 dark:bg-blue-950/10 p-4 rounded-xl space-y-2.5">
          <div className="text-xs font-bold uppercase tracking-wider text-blue-700 dark:text-blue-400 flex items-center space-x-1.5">
          ...
          <button
            ...
            className="bg-blue-600 hover:bg-blue-700 text-white text-xs font-semibold px-3.5 py-2 rounded-lg shadow-xs transition flex items-center space-x-1.5 min-h-[36px]"
          >
        ...
        <button
          type="submit"
          className="w-full bg-blue-600 hover:bg-blue-700 text-white font-semibold py-3 rounded-lg text-sm shadow-xs transition flex items-center justify-center space-x-2 min-h-[44px]"
        >
