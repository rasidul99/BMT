  ...
  const renderNavContent = (collapsed: boolean, isMobileDrawer = false) => (
    <>
      ...
      <div className="pt-2 border-t border-border mt-2">
        ...
        <button
          onClick={() => {
            router.push(`/workspace/${workspaceId}/advanced/connect-accounts`)
            closeMobileSidebar()
          }}
  ...
  return (
    <div className="flex flex-col h-screen bg-background text-foreground overflow-hidden">
      ...
      <div className="flex flex-1 overflow-hidden relative">
        ...
        {/* Main content area (100% full width on mobile) */}
        <main className="flex-1 overflow-auto p-3.5 sm:p-5 md:p-6 bg-background">
          {children}
        </main>
      </div>
    </div>
